...
class GlobeApp extends StatefulWidget {
  const GlobeApp({Key? key}) : super(key: key);

  @override
  _GlobeAppState createState() => _GlobeAppState();
}

class _GlobeAppState extends State<GlobeApp> with TickerProviderStateMixin {
